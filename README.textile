...
p. EasyTester is a simple test tool for *WebService* and *Web* (__eg. HTTP gateway.do response__). All you have to do is to write a short script and prepare the test case.
...
p. 1. Soap4R
Soap4R is used to invoke WebServices, and wsdl2ruby.rb is used to generate stubs.
@gem install soap4r@

p. 2. Nokogiri
Nokogiri is needed when parsing XPath.
